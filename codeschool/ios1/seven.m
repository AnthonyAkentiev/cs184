// View Controller - Navigation Controllers
...
-(void) showProfile:(UIButton*)target
{
     ProfileViewController* pwc = [[ProfileViewController alloc]init];
     [self.navigationController pushViewController:pwc
          animated:YES];  
}
